...
from agent.baselines import ThresholdAgent, PredictiveHeuristicAgent, StaticAgent, run_baseline
...
TASK_MAP = {
    "steady": make_steady_env,
    "spike": make_spike_env,
    "chaos": make_chaos_env
}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--agent", type=str, default="threshold", choices=["threshold", "predictive", "static3", "static5"])
