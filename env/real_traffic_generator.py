...
from .traffic_generator import TrafficGenerator, TrafficConfig
...
class RealTimeTrafficGenerator(TrafficGenerator):
    ...
    def __init__(self, config: TrafficConfig, api_url: str = "http://localhost:8000/data", use_json_fallback: bool = True):
